        ...
        <div className="container mt-5">
            ...
            <div>
                {listeAnnonce.map(liste => (
                    liste.etatAnnonce === 0 && (
                        <div key={liste.idAnnonce} style={{ border: '4px solid rgb(101 66 66)', padding: '10px', borderRadius: '5px',marginLeft:'-60px',marginTop:'30px',backgroundColor:'rgb(213, 213, 219)' }}>
                            <ul >
