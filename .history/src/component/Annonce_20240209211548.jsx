        ...
        >
            ...
            <li>Boite de vitesse :{liste.nomBoiteDeVitesse}</li>
                                ...
                                <div className='BoutonBleu'>
                                    <button className="btn btn-secondary"  onClick={() => mettreFavorie(liste.idAnnonce)} style={{ margin: '10px', borderRadius: '5px', marginLeft: '-15px',width: '90%' }}> Mettre favorie</button>
                                </div>
                            </ul>
                        </div>
                    )
