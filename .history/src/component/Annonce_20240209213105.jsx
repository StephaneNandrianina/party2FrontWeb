                        ...
                        <div key={liste.idAnnonce}>
                            ...
                            >
                                ...
                                <div className='BoutonBleu'>
                                    <button className="btn btn-secondary"  onClick={() => mettreFavorie(liste.idAnnonce)} style={{ margin: '10px', borderRadius: '5px',width: '90%',marginLeft:'-px' }}> Mettre favorie</button>
                                </div>
                            </ul>
                        </div>
                    )
