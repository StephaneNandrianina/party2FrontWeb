        ...
        <div className="container mt-5">
            ...
            <div>
                {listeAnnonce.map(liste => (
                    liste.etatAnnonce === 0 && (
                        <div key={liste.idAnnonce} style={{ border: '4px solid #ccc', padding: '10px', borderRadius: '5px',marginLeft:'-60px',marginTop:'30px' }}>
                            <ul >
                            ...
                            >
                                {accordeonOuvert[liste.idAnnonce] ? 'Fermer' : 'Voir'} Détail
                                    ...
                                    {accordeonOuvert[liste.idAnnonce] && (
                                        ...
                                        >
                                            <li> <b style={{color:'green'}}></b>Createur : <h4>{liste.nomUtilisteur}</h4> </li>
                                            <li> <b style={{color:'green'}}></b>Description : {liste.description}</li>
                                            <li> <b style={{color:'green'}}></b>Lieu :{liste.nomLieu}</li>
                                            <li> <b style={{color:'green'}}></b>Année : {liste.annee}</li>
                                            <li> <b style={{color:'green'}}></b>Prix :<h6>{liste.prix} Ariary</h6></li>
                                            <li> <b style={{color:'green'}}></b>Marque :{liste.nomMarque}</li>
                                            <li> <b style={{color:'green'}}></b>Model :{liste.nomModel}</li>
                                            <li> <b style={{color:'green'}}></b>Categorie :{liste.nomCategorie}</li>
                                            <li> <b style={{color:'green'}}></b>Couleur :{liste.nomCouleur}</li>
                                            <li> <b style={{color:'green'}}></b>Matricule :{liste.imatricule}</li>
                                            <li> <b style={{color:'green'}}></b>Carburant :{liste.nomCarburant}</li>
                                            <li> <b style={{color:'green'}}></b>Boite de vitesse :{liste.nomBoiteDeVitesse}</li>
                                        </div>
                                    )}
                                </div>
                                <Link to="/Message">
