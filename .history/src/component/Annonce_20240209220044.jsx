        ...
        <div className="container mt-5">
            ...
            <div>
                {listeAnnonce.map(liste => (
                    liste.etatAnnonce === 0 && (
                        <div key={liste.idAnnonce} style={{ border: '4px solid #ccc', padding: '10px', borderRadius: '5px',marginLeft:'-60px',marginTop:'30px',backgroundColor:'' }}>
                            <ul >
                                ...
                                <div>
                                    {liste.photoVoiture.map((listeImage) => (
                                        <img alt="" src={listeImage.nomPhotoVoiture} style={{ width: '50%', height: 'auto', marginLeft: '30px', marginTop: '30px' }} />
                                    ))}
                                </div>
