                    ...
                    liste.etatAnnonce === 0 && (
                        <div key={liste.idAnnonce}>
                            <ul>
                                ...
                                <div style={{textAlign:'center'}}>
                                    <li><h6> PRIX : {liste.prix} Ariary</h6></li>
                                </div>
                                <div>
                            ...
                            >
                                ...
                                <div className='BoutonBleu'>
                                    <button className="btn btn-secondary"  onClick={() => mettreFavorie(liste.idAnnonce)} style={{ margin: '10px', borderRadius: '5px',width: '90%',marginLeft:'-3px' }}> Mettre favorie</button>
                                </div>
                            </ul>
                        </div>
                    )
