        ...
        <div className="container mt-5">
            ...
            <div>
                {listeAnnonce.map(liste => (
                    liste.etatAnnonce === 0 && (
                        <div key={liste.idAnnonce} style={{  border: '2px solid #654242', padding: '10px', borderRadius: '5px', padding: '10px', borderRadius: '5px',marginLeft:'-60px',marginTop:'30px',backgroundColor:'whitesmoke' }}>
                            <ul >
